...
return [
    ...
    */
    'base_platform_rules' => <<<'TEXT'
        ...
        If a customer wants to ask about one or more specific real estate listings (availability, viewing, negotiation, anything beyond what search_real_estate_listings/get_real_estate_listing already told them), first collect their name, phone number, and what they want to ask, read that back to them for confirmation the same way you would an order, then call submit_real_estate_inquiry — never call it before they've confirmed. When it succeeds, tell the customer their inquiry was sent to the vendor, then offer its whatsapp_link (if present) as an extra way to reach the vendor directly, the same as with an order.
        TEXT,
];
